...
// const generateImageURL = async (prompt: string): Promise<string> => {
//   return `https://source.unsplash.com/1024x1024/?${encodeURIComponent(
//     prompt
//   )}`;
// };
...
// - English text only
// - Avoid cartoon or abstract style
// `;
...
`;
    ...
    // Pollinations AI (stable + fast + no API key required)
    ...
    // Better fallback (professional themed fallback image)
    return `https://plus.unsplash.com/premium_photo-1729004379397-ece899804701?q=80&w=2767&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D`;
  }
};
...
"twoColumns", "twoColumnsWithHeading",
"fourColumns", "twoImageColumns", "threeImageColumns",
"fourImageColumns", "tableLayout", "blank-card"
