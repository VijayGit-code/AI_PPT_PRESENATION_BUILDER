...
const CreateAI = ({ onBack }: CreativeAIProps) => {
  ...
  const handleVoiceInput = () => {
    ...
    recognition.onresult = (event: any) => {
      ...
      setCurrentAIPrompt(transcript); // updates the input field
    };
...
// };
 ...
 const handleFileUpload = async (
  ...
  />
             <Button onClick={handleVoiceInput} size="icon"  variant="outline" aria-label="Voice input">
              <Mic className="h-5 w-5" />
              </Button>
            <Button  variant={"destructive"}  onClick={resetCards}  size="default"  aria-label="Reset Cards"  className="cursor-pointer">
